...
The library converts the raw response into a `Gegosoft/Rippled/Api/Response` object with the following process.
...
$client = new \Gegosoft\Rippled\Client('https://s1.ripple.com:51234');
